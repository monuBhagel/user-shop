...
class MyFatoorahPaymentScreen extends StatefulWidget {
  const MyFatoorahPaymentScreen({super.key, required this.url});
  final String url;

  @override
  State<MyFatoorahPaymentScreen> createState() => _MolliePaymentState();
}

class _MolliePaymentState extends State<MyFatoorahPaymentScreen> {
  double value = 0.0;
