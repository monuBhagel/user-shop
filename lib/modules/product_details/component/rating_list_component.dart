...
class ReviewListComponent extends StatelessWidget {
  const ReviewListComponent(this.productReviews, {super.key});
          ...
          if (productReviews.length > 3)
            Container(
              ...
              child: InkWell(
                ...
                child: CustomText(text: Language.seeAllReview, color: redColor),
              ),
            )
        ],
      ),
  ...
  Widget _buildRatingHeader() {
    return Container(
      ...
      child: Row(
        children: [
          CustomText(
              text: Utils.getRating(productReviews).toStringAsFixed(1),
              isTranslate: false,
              fontSize: 30.0,
          ...
          Column(
            ...
            children: [
              ...
              CustomText(
                  text: '${productReviews.length} ${Language.reviews}',
                  fontSize: 16.0,
                  color: iconGreyColor)
            ],
          ),
