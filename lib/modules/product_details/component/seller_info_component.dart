  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  CustomText(
                    text: productDetailsModel?.sellerProfile?.shopName ??
                        'Demo name',
                    isTranslate: false,
                    fontSize: 18.0,
                  ...
                  CustomText(
                    text: productDetailsModel?.sellerProfile?.address ??
                        'No address found',
                    fontSize: 14.0,
                    height: 1.5,
                    color: iconGreyColor,
                 ...
                 if(productDetailsModel?.sellerReviewQty != 0)...[
                   Row(
                     children: [
                       RatingBar.builder(
                         initialRating:
                       ...
                       Container(
                           ...
                           color: borderColor),
                       CustomText(
                           text: productDetailsModel?.sellerTotalReview
                               .toString() ??
                               '',
                           fontSize: 13,
        ...
        Divider(color: grayBorderColor.withOpacity(0.8)),
        const SizedBox(height: 8),
      ],
    );
  }
