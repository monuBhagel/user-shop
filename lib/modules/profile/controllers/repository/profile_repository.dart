...
abstract class ProfileRepository {
  ...
  Future<Either<dynamic, String>> profileUpdate(
      ProfileEditStateModel user, String token);
  ...
  Future<Either<Failure, String>> removeWishList(String id, String token);

  Future<Either<Failure, String>> clearWishList(String token);

  Future<Either<Failure, String>> deleteUserAccount(String token);

  Future<Either<Failure, String>> addWishList(String id, String token);
}
...
class ProfileRepositoryImp extends ProfileRepository {
  ...
  @override
  Future<Either<Failure, String>> passwordChange(
      ChangePasswordStateModel changePassData, String token) async {
    try {
      final result =
  ...
  Future<Either<Failure, String>> profileUpdate(
      ProfileEditStateModel user, String token) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> removeWishList(String id, String token) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> addWishList(String id, String token) async {
    try {
